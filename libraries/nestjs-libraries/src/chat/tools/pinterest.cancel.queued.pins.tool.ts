    ...
    return createTool({
      ...
      inputSchema: z.object({
        ...
        itemIds: z
          ...
          .max(200)
          .describe(
            'The "id" values (not pin ids) of queued items to cancel, from pinterestDeletePinsQueueStatusTool\'s queuedItems list'
          ),
      }),
      ...
      execute: async (args, options) => {
        ...
        const result = await this._pinterestDeleteService.cancelItems(
          organizationId,
