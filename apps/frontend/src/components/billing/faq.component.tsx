  ...
  return [
      ...
      ? [
          {
            title: t(
              ...
              'Am I going to be charged by Content Warrior?'
            ),
            description: t(
              'faq_to_confirm_credit_card_information_postiz_will_hold',
              'To confirm credit card information Content Warrior will hold $2 and release it immediately'
            ),
          },
        ]
      : []),
    {
      title: t(
        ...
        `Can I trust ${isGeneral ? 'Content Warrior' : 'Gitroom'}?`
      ),
      description: t(
        'faq_postiz_gitroom_is_proudly_open_source',
        `${
          isGeneral ? 'Content Warrior' : 'Gitroom'
